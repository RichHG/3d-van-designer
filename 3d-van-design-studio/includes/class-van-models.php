    ...
    public static function get_available_models() {
        $models = array(
            ...
            'furniture' => array(
                ...
                array(
                    'id' => 'utensils-pot',
                    'name' => 'Utensils In Pot',
                    'file' => VAN_BUILDER_MODELS_URL . 'furniture/kitchen/kitchen_utensils_in_the_pot.glb',
                    'thumbnail' => VAN_BUILDER_ASSETS_URL . 'images/thumbnails/furniture/kitchen/kitchen_utensils_in_the_pot.png',
                    'category' => 'storage'
                ),
                array(
                    'id' => 'kitchen-sink',
                    'name' => 'Kitchen Sink',
                    'file' => VAN_BUILDER_MODELS_URL . 'furniture/kitchen/kitchen_sink.glb',
                    'thumbnail' => VAN_BUILDER_ASSETS_URL . 'images/thumbnails/furniture/kitchen/kitchen_sink.png',
                    'category' => 'kitchen'
                ),
                array(
                    'id' => 'microwave',
                    'name' => 'Microwave',
                    'file' => VAN_BUILDER_MODELS_URL . 'furniture/kitchen/microwave.glb',
                    'thumbnail' => VAN_BUILDER_ASSETS_URL . 'images/thumbnails/furniture/kitchen/microwave.png',
                    'category' => 'kitchen'
                ),
                array(
                    'id' => 'toilet',
            ...
            'materials' => array(
                array(
                    'id' => 'wood',
                    'name' => 'Wood',
                    'texture' => VAN_BUILDER_ASSETS_URL . 'textures/wood.jpg',
